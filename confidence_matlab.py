...
if __name__ == "__main__":
    ...
    if True:
        ...
        model_checkpoint = keras.callbacks.ModelCheckpoint("./conf_matlab.hdf5", save_best_only=True, verbose=1)
        ...
        with tf.device('/gpu:0'):
            try:
                ...
                nn_predictor.save("./conf_matlab.hdf5")
                with open('./conf_matlab_hist', 'wb') as file_pi:
